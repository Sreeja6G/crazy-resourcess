...
export default function FreshJobs({ setCurrentPage }) {
  ...
  const freshJobs = {
    "IT & Software": [
      { title: "Junior Software Developer", company: "TCS", location: "Bangalore", salary: "3-4 LPA", experience: "Fresher", type: "Full-time", url: "https://www.tcsapply.com/careers" },
      { title: "Java Developer Trainee", company: "Infosys", location: "Pune", salary: "2.8-3.5 LPA", experience: "Fresher", type: "Full-time", url: "https://infosys.wd3.myworkdaysite.com" },
      { title: "Frontend Developer (Fresher)", company: "Wipro", location: "Hyderabad", salary: "3-3.8 LPA", experience: "Fresher", type: "Full-time", url: "https://wipro.eightfold.ai/careers" },
      { title: "Python Developer Intern", company: "HCL Technologies", location: "Delhi", salary: "2.5-3.2 LPA", experience: "Fresher", type: "Full-time", url: "https://hcljobs.recruit.net" },
      { title: "Web Developer Fresher", company: "Tech Mahindra", location: "Mumbai", salary: "2.8-3.6 LPA", experience: "Fresher", type: "Full-time", url: "https://techmahindra.applytojob.com" },
      { title: "Associate Software Engineer", company: "Accenture", location: "Bangalore", salary: "3.2-4 LPA", experience: "Fresher", type: "Full-time", url: "https://www.accenture.com/us-en/careers/jobsearch" },
      ...
      { title: "Software Engineer Graduate", company: "Cognizant", location: "Pune", salary: "2.9-3.6 LPA", experience: "Fresher", type: "Full-time", url: "https://cognizant.wd3.myworkdaysite.com" },
      { title: "Full Stack Developer Trainee", company: "Capgemini", location: "Hyderabad", salary: "3.1-3.8 LPA", experience: "Fresher", type: "Full-time", url: "https://capgemini.wd3.myworkdaysite.com" },
      { title: "QA Tester Fresher", company: "Genpact", location: "Bangalore", salary: "2.5-3 LPA", experience: "Fresher", type: "Full-time", url: "https://genpact.wd3.myworkdaysite.com" },
      { title: "Data Analyst Fresher", company: "EY", location: "Mumbai", salary: "3-3.7 LPA", experience: "Fresher", type: "Full-time", url: "https://ey.wd3.myworkdaysite.com" },
      { title: "DevOps Engineer (Entry Level)", company: "Deloitte", location: "Bangalore", salary: "3.2-4 LPA", experience: "Fresher", type: "Full-time", url: "https://deloitte.wd3.myworkdaysite.com" },
    ],
    "Data Science & Analytics": [
      { title: "Junior Data Scientist", company: "Amazon", location: "Bangalore", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://amazon.wd5.myworkdaysite.com" },
      { title: "Data Analyst Fresher", company: "Google", location: "Delhi", salary: "4.5-5.5 LPA", experience: "Fresher", type: "Full-time", url: "https://careers.google.com/jobs/results" },
      { title: "ML Engineer (Entry Level)", company: "Microsoft", location: "Hyderabad", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://careers.microsoft.com/us/en/search-results" },
      { title: "Business Analyst Trainee", company: "Flipkart", location: "Bangalore", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://flipkart.eightfold.ai/careers" },
      { title: "Data Science Intern", company: "Airbnb", location: "Mumbai", salary: "3.5-4.5 LPA", experience: "Fresher", type: "Internship", url: "https://airbnb.wd5.myworkdaysite.com" },
      { title: "Analytics Associate", company: "Swiggy", location: "Bangalore", salary: "3.8-4.8 LPA", experience: "Fresher", type: "Full-time", url: "https://swiggy.eightfold.ai/careers" },
      { title: "Junior Data Engineer", company: "Zomato", location: "Bangalore", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://zomato.eightfold.ai/careers" },
      { title: "ML Trainee", company: "Uber", location: "Hyderabad", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://www.uber.com/en-IN/careers/list" },
    ],
    "Finance & Banking": [
      { title: "Graduate Trainee - Banking", company: "ICICI Bank", location: "Mumbai", salary: "3-3.5 LPA", experience: "Fresher", type: "Full-time", url: "https://icicibank.wd3.myworkdaysite.com" },
      { title: "Junior Associate - Finance", company: "HDFC Bank", location: "Delhi", salary: "2.8-3.3 LPA", experience: "Fresher", type: "Full-time", url: "https://hdfcbank.wd3.myworkdaysite.com" },
      { title: "Accounts Executive Fresher", company: "Axis Bank", location: "Bangalore", salary: "2.5-3 LPA", experience: "Fresher", type: "Full-time", url: "https://axisbank.wd3.myworkdaysite.com" },
      { title: "Financial Analyst Trainee", company: "Goldman Sachs", location: "Mumbai", salary: "6-7 LPA", experience: "Fresher", type: "Full-time", url: "https://www.goldmansachs.com/careers/job-search" },
      { title: "Compliance Officer Fresher", company: "Nomura", location: "Mumbai", salary: "4-5 LPA", experience: "Fresher", type: "Full-time", url: "https://nomura.wd5.myworkdaysite.com" },
      { title: "Risk Analyst Fresher", company: "Morgan Stanley", location: "Bangalore", salary: "5-6 LPA", experience: "Fresher", type: "Full-time", url: "https://morganstanley.wd5.myworkdaysite.com" },
      { title: "Junior Accountant", company: "Deloitte", location: "Pune", salary: "3.2-3.8 LPA", experience: "Fresher", type: "Full-time", url: "https://deloitte.wd3.myworkdaysite.com" },
      { title: "Credit Analyst Trainee", company: "RBI", location: "Mumbai", salary: "5-6 LPA", experience: "Fresher", type: "Full-time", url: "https://www.rbi.org.in/Scripts/Recruitment.aspx" },
    ],
    "Consulting": [
      { title: "Associate Consultant Fresher", company: "McKinsey", location: "Mumbai", salary: "12-14 LPA", experience: "Fresher", type: "Full-time", url: "https://www.mckinsey.com/careers/apply" },
      { title: "Junior Consultant", company: "Boston Consulting Group", location: "Delhi", salary: "11-13 LPA", experience: "Fresher", type: "Full-time", url: "https://www.bcg.com/careers/search" },
      { title: "Analyst - Strategy", company: "Bain & Company", location: "Bangalore", salary: "10-12 LPA", experience: "Fresher", type: "Full-time", url: "https://www.bain.com/careers/search-jobs" },
      { title: "Management Consultant", company: "EY Consulting", location: "Mumbai", salary: "8-10 LPA", experience: "Fresher", type: "Full-time", url: "https://ey.wd3.myworkdaysite.com" },
      { title: "Business Analyst Fresher", company: "Deloitte Consulting", location: "Bangalore", salary: "7-9 LPA", experience: "Fresher", type: "Full-time", url: "https://deloitte.wd3.myworkdaysite.com" },
      { title: "Junior Associate - Consulting", company: "KPMG", location: "Pune", salary: "6-8 LPA", experience: "Fresher", type: "Full-time", url: "https://kpmg.wd5.myworkdaysite.com" },
    ],
    "Sales & Marketing": [
